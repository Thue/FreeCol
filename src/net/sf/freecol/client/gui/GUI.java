...
public class GUI {
     ...
     */
    public void displaySplashScreen(final String splashFilename, GraphicsDevice gd) {
        splash = null;
     ...
     */
    public void startGUI(GraphicsDevice gd, Dimension innerWindowSize, boolean sound) {
